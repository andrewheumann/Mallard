...
namespace AirtableGH
{
    public class AirtableRecordFieldsGH : GH_Component
    {
        ...
        public AirtableRecordFieldsGH() : base("Airtable Record Fields", "Record Fields", "Get the Field Values" +
            "from a list of Airtable Records for the Supplied Field Name", "Mallard", "Database")
        {
